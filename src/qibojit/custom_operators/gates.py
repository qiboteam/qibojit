...
def apply_three_qubit_gate_kernel(state, gate, qubits, nstates, targets):
	for g in prange(nstates):
		...
		t0 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2])
		buffer0 = state[t0]
		t1 = ig - (1 << targets[1]) - (1 << targets[2])
		buffer1 = state[t1]
		t2 = ig - (1 << targets[0]) - (1 << targets[2])
		buffer2 = state[t2]
		t3 = ig - (1 << targets[2])
		buffer3 = state[t3]
		t4 = ig - (1 << targets[0]) - (1 << targets[1])
		buffer4 = state[t4]
		t5 = ig - (1 << targets[1])
		buffer5 = state[t5]
		t6 = ig - (1 << targets[0])
...
def apply_four_qubit_gate_kernel(state, gate, qubits, nstates, targets):
	for g in prange(nstates):
		ig = multicontrol_index(g, qubits)
		t0 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3])
		buffer0 = state[t0]
		t1 = ig - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3])
		buffer1 = state[t1]
		t2 = ig - (1 << targets[0]) - (1 << targets[2]) - (1 << targets[3])
		buffer2 = state[t2]
		t3 = ig - (1 << targets[2]) - (1 << targets[3])
		buffer3 = state[t3]
		t4 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[3])
		buffer4 = state[t4]
		t5 = ig - (1 << targets[1]) - (1 << targets[3])
		buffer5 = state[t5]
		t6 = ig - (1 << targets[0]) - (1 << targets[3])
		buffer6 = state[t6]
		t7 = ig - (1 << targets[3])
		buffer7 = state[t7]
		t8 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2])
		buffer8 = state[t8]
		t9 = ig - (1 << targets[1]) - (1 << targets[2])
		buffer9 = state[t9]
		t10 = ig - (1 << targets[0]) - (1 << targets[2])
		buffer10 = state[t10]
		t11 = ig - (1 << targets[2])
		buffer11 = state[t11]
		t12 = ig - (1 << targets[0]) - (1 << targets[1])
		buffer12 = state[t12]
		t13 = ig - (1 << targets[1])
		buffer13 = state[t13]
		t14 = ig - (1 << targets[0])
...
def apply_five_qubit_gate_kernel(state, gate, qubits, nstates, targets):
	for g in prange(nstates):
		ig = multicontrol_index(g, qubits)
		t0 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3]) - (1 << targets[4])
		buffer0 = state[t0]
		t1 = ig - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3]) - (1 << targets[4])
		buffer1 = state[t1]
		t2 = ig - (1 << targets[0]) - (1 << targets[2]) - (1 << targets[3]) - (1 << targets[4])
		buffer2 = state[t2]
		t3 = ig - (1 << targets[2]) - (1 << targets[3]) - (1 << targets[4])
		buffer3 = state[t3]
		t4 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[3]) - (1 << targets[4])
		buffer4 = state[t4]
		t5 = ig - (1 << targets[1]) - (1 << targets[3]) - (1 << targets[4])
		buffer5 = state[t5]
		t6 = ig - (1 << targets[0]) - (1 << targets[3]) - (1 << targets[4])
		buffer6 = state[t6]
		t7 = ig - (1 << targets[3]) - (1 << targets[4])
		buffer7 = state[t7]
		t8 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[4])
		buffer8 = state[t8]
		t9 = ig - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[4])
		buffer9 = state[t9]
		t10 = ig - (1 << targets[0]) - (1 << targets[2]) - (1 << targets[4])
		buffer10 = state[t10]
		t11 = ig - (1 << targets[2]) - (1 << targets[4])
		buffer11 = state[t11]
		t12 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[4])
		buffer12 = state[t12]
		t13 = ig - (1 << targets[1]) - (1 << targets[4])
		buffer13 = state[t13]
		t14 = ig - (1 << targets[0]) - (1 << targets[4])
		buffer14 = state[t14]
		t15 = ig - (1 << targets[4])
		buffer15 = state[t15]
		t16 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3])
		buffer16 = state[t16]
		t17 = ig - (1 << targets[1]) - (1 << targets[2]) - (1 << targets[3])
		buffer17 = state[t17]
		t18 = ig - (1 << targets[0]) - (1 << targets[2]) - (1 << targets[3])
		buffer18 = state[t18]
		t19 = ig - (1 << targets[2]) - (1 << targets[3])
		buffer19 = state[t19]
		t20 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[3])
		buffer20 = state[t20]
		t21 = ig - (1 << targets[1]) - (1 << targets[3])
		buffer21 = state[t21]
		t22 = ig - (1 << targets[0]) - (1 << targets[3])
		buffer22 = state[t22]
		t23 = ig - (1 << targets[3])
		buffer23 = state[t23]
		t24 = ig - (1 << targets[0]) - (1 << targets[1]) - (1 << targets[2])
		buffer24 = state[t24]
		t25 = ig - (1 << targets[1]) - (1 << targets[2])
		buffer25 = state[t25]
		t26 = ig - (1 << targets[0]) - (1 << targets[2])
		buffer26 = state[t26]
		t27 = ig - (1 << targets[2])
		buffer27 = state[t27]
		t28 = ig - (1 << targets[0]) - (1 << targets[1])
		buffer28 = state[t28]
		t29 = ig - (1 << targets[1])
		buffer29 = state[t29]
		t30 = ig - (1 << targets[0])
